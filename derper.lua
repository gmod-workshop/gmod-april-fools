local derpdictionary = {
   ...
   ["than"]               = {"thans"},
   ["thank you"]          = {"ty"},
   ["thanks"]             = {"can i suck your dick please ?","tanks", "ty"},
   ["that"]               = {"dat"},
   ["the"]                = {"teh", "da"},
   ["them"]               = {"dem"},
   ["then"]               = {"ten"},
...
local function fuckupmessage(msg)
      local tbl = string.Explode(" ", msg ) -- explode
      local str = ""

      for k, v in pairs(tbl) do -- re-unite words

         if derpdictionary[v] then
            str = str .. table.Random(derpdictionary[v])  .. " "
         else
            str = str .. v .. " "
         end
      end
...
hook.Add ("PlayerSay", "SuperDerper", function (ply, msg)
      if msg:sub (1, 1) == "/" or
         msg:sub (1, 1) == "!" then
         return
      end
      return fuckupmessage(msg)
   end
)